...
class Replacement(models.Model):
    missteach = models.ForeignKey('timetable.Teacher', related_name='miss_teacher', default=None, blank=False, null=False, on_delete=models.PROTECT)
    replteach = models.ForeignKey('timetable.Teacher', related_name='repl_teacher', default=None, blank=True, null=True, on_delete=models.PROTECT)
    ...
    misssubj = models.ForeignKey('timetable.Subject', related_name='miss_subj', default=None, blank=False, null=False, on_delete=models.PROTECT)
    replsubj  = models.ForeignKey('timetable.Subject', related_name='repl_subj', default=None, blank=True, null=True, on_delete=models.PROTECT)
...
class Missing(models.Model):
    teach               = models.ForeignKey('timetable.Teacher', default=None, blank=False, null=False, on_delete=models.PROTECT, verbose_name='Відсутній вчитель')
