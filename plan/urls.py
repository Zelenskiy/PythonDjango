...
from plan.views import index, imp_from_excel, view, postr,  \
    update_plan, Post_delete, ribbon, ribbview,rib_update_plan, export_word, rib_add_plan, rib_del_plan
...
urlpatterns = [
                  ...
                  path('rib_add_plan/', rib_add_plan, name='rib_add_plan_url'),
                  path('rib_del_plan/<int:id>/', rib_del_plan, name='rib_del_plan_url'),
